...
test_cases = [
    {
        ...
        "collider_densities_values": [
            {"ortho-H2": 1e2 / constants.centi**3, "para-H2": 1e3 / constants.centi**3},
...
def RADEX_out_filename(
    radex_geometry, specie, Tkin, T_background, N, collider_densities
):
    rg = radex_geometry.replace(" ", "").replace("\n", "")
    save_filename = (
        f"radex_{rg}_{specie}_Tkin{Tkin}_Tbg{T_background}_"
