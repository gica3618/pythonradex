...
exec_paths = {
    ID: os.path.join(folderpath, f"../Radex/bin/{ex}") for ID, ex in executables.items()
}


def write_RADEX_input_file(
    mol_data_filename, Tkin, collider_densities, T_background, N, width_v
):
