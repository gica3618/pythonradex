...
def write_RADEX_input_file(mol_data_filename,Tkin,collider_densities,Ntot,width_v):
...
for test_case in RADEX_test_cases.test_cases:
    ...
    for collider_densities,Ntot,Tkin in\
        ...
        write_RADEX_input_file( 
               ...
               Ntot=Ntot,width_v=RADEX_test_cases.width_v)
        ...
        save_filename = RADEX_test_cases.RADEX_out_filename(
                          ...
                          Ntot=Ntot,collider_densities=collider_densities)
