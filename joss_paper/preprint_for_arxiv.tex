...
\author[1%
  %
  \ensuremath\mathparagraph]{Gianni Cataldi%
...
simplified geometry. I present a Python re-implementation of
\texttt{RADEX}: \texttt{pythonradex}. Written in Python, it provides an
easy and intuitive user interface, improved performance as well as
additional functionality not included in \texttt{RADEX} (continuum
effects and overlapping lines).
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{code/pythonradex_vs_radex.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{code/HCN_spec.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{flux_comparison_spherical_geometries.pdf}}
