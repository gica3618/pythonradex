...
for test_case in test_cases:
    print(test_case)
    for coll_density, N, Tkin in itertools.product(
        test_case["coll_partner_densities"],
        test_case["N_values"],
        test_case["Tkin_values"],
    ):
        cloud_kwargs = {
            "datafilepath": general.datafilepath(test_case["data_filename"]),
            "geometry": geometry,
        ...
        if Tex_relative_diff > 0.1 or flux_relative_diff > 0.1:
            ...
            print(
                f"coll dens = {coll_density/constants.centi**-3:.2g} cm-3, "
