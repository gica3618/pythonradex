...
source.update_parameters(
    ...
    Tkin=20,
    collider_densities={collider: 1e4 / constants.centi**3},
...
start = time.time()
source = generate_new_source()
for N, coll_dens, Tkin in itertools.product(N_values, coll_density_values, Tkin_values):
