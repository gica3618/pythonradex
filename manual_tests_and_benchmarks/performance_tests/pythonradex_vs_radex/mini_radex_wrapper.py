...
def run_radex(datafilename,geometry,collider_densities,Tkin,N,width_v,
    ...
    assert os.path.exists(output_filepath),"Radex failed? Remove /dev/null to see radex output"
    end_assert = time.perf_counter()
    return {"setup":end_setup-start_setup,"calc":end_calc-start_calc,
...
if __name__ == "__main__":
    ...
    times = run_radex(datafilename=datafilename,geometry=geometry,
                      ...
                      width_v=width_v,input_filepath=input_filepath,
