...
source.update_parameters(
    ...
    Tkin=grid_definition.grid["Tkin_grid"][0],
    collider_densities={
        collider: grid_definition.coll_density_values[0]
        for collider in grid_definition.grid["colliders"]
    },
    N=grid_definition.grid["N_grid"][0],
    T_dust=0,
    tau_dust=0,
)
