...
N_values = (
    1e13 / constants.centi**2,
    1e14 / constants.centi**2,
    1e17 / constants.centi**2,
...
for N in N_values:
    ...
    for ng in (True, False):
        ...
        solve_time = timeit.timeit(
            source.solve_radiative_transfer, number=timeit_number
        )
        max_tau = np.max(source.tau_nu0_individual_transitions)
        Tex_10 = source.Tex[0]
        print(
            f"time for ng {ng}, max tau {max_tau:.4g}, "
