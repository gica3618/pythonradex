...
colliders = [
    pyLime.Collider(name="e", density=ne),
...
datafolder = (
    "/home/gianni/science/projects/code/pythonradex_joss/pythonradex/tests/LAMDA_files"
)
radiating_species = [
    pyLime.RadiatingSpecie(moldatfile=os.path.join(datafolder, "c.dat"), density=ne),
    pyLime.RadiatingSpecie(moldatfile=os.path.join(datafolder, "c+.dat"), density=ne),
]
Mstar = 2e30 * 1.75
...
image_c = pyLime.LimeImage(
    theta=0, filename="test_c.fits", molI=0, **general_img_kwargs
)
image_cplus = pyLime.LimeImage(
