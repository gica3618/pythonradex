...
molpop_Tex = {"treat_overlap": [7.87e00, 7.46e01], "ignore_overlap": [2.72e00, 8.56e01]}
molpop_tau_nu0 = {
    "treat_overlap": [3.32e-04, 3.73e-03],
    "ignore_overlap": [1.20e-01, 1.27e00],
}
...
molpop_column_densities = {
    "treat_overlap": 2.72e11 / constants.centi**2 / constants.kilo * Doppler,
    "ignore_overlap": 1.04e14 / constants.centi**2 / constants.kilo * Doppler,
}
Tkin = 100
collider_densities = {
...
for overlap, N in molpop_column_densities.items():
    ...
    for i, trans_index in enumerate(ref_transitions):
        ...
        print(
            f"tau_nu0={source.tau_nu0_individual_transitions[trans_index]:.3g}"
